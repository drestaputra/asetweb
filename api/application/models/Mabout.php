...
class Mabout extends CI_Model {
	...
	function get_about(){
		...
		$where='configuration_index in ("app_name","app_description","app_dev","app_dev_web","app_contact_ig","app_contact_fb","app_contact_twitter","app_contact_mail","app_contact_wa","app_contact_phone","app_contact_address","app_is_aset_show")';
		$this->db->where($where);
