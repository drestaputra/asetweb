...
class Maset extends CI_Model {
    ...
    public function data_saran_pemanfaatan($params,$custom_select='',$count=false,$additional_where='', $order_by="isi_saran_pemanfaatan DESC")
    {
        ...
        $where.=$additional_where;
        $params['table'] = 'saran_pemanfaatan';
        $params['select'] = '*';
