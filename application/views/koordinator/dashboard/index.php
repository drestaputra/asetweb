...
<!-- Vendor -->		
		...
		<script>
			...
			function load_grafik_user(){
				morrisAreaData = [];
				$.ajax({
				url: '<?php echo base_url('koordinator/dashboard/get_grafik_user') ?>',
				type: 'POST',
				dataType: 'JSON',
				data: {tahun: $("#tahun_grafik_user").val()},
				success : function(response){
					data_koperasi = response['koperasi'];							
					data_koordinator = response['koordinator'];							
					...
					data_nasabah = response['nasabah'];							
						...
						morrisAreaData = [{
							y: 'Januari',
							a: data_koperasi[1],
							b: data_koordinator[1],
							c: data_kolektor[1],
							d: data_nasabah[1],							
						}, {
							y: 'Februari',
							a: data_koperasi[2],
							b: data_koordinator[2],
							c: data_kolektor[2],
							d: data_nasabah[2],							
						}, {
							y: 'Maret',
							a: data_koperasi[3],
							b: data_koordinator[3],
							c: data_kolektor[3],
							d: data_nasabah[3],							
						}, {
							y: 'April',
							a: data_koperasi[4],
							b: data_koordinator[4],
							c: data_kolektor[4],
							d: data_nasabah[4],							
						}, {
							y: 'Mei',
							a: data_koperasi[5],
							b: data_koordinator[5],
							c: data_kolektor[5],
							d: data_nasabah[5],							
						}, {
							y: 'Juni',
							a: data_koperasi[6],
							b: data_koordinator[6],
							c: data_kolektor[6],
							d: data_nasabah[6],							
						}, {
							y: 'Juli',
							a: data_koperasi[7],
							b: data_koordinator[7],
							c: data_kolektor[7],
							d: data_nasabah[7],							
						}, {
							y: 'Agustus',
							a: data_koperasi[8],
							b: data_koordinator[8],
							c: data_kolektor[8],
							d: data_nasabah[8],							
						}, {
							y: 'September',
							a: data_koperasi[9],
							b: data_koordinator[9],
							c: data_kolektor[9],
							d: data_nasabah[9],							
						}, {
							y: 'Oktober',
							a: data_koperasi[10],
							b: data_koordinator[10],
							c: data_kolektor[10],
							d: data_nasabah[10],														
						}, {
							y: 'November',
							a: data_koperasi[11],
							b: data_koordinator[11],
							c: data_kolektor[11],
							d: data_nasabah[11],														
						},{
							y: 'Desember',
							a: data_koperasi[12],
							b: data_koordinator[12],
							c: data_kolektor[12],
							d: data_nasabah[12],							
						}];					
			...
			function load_grafik_transaksi(){
				...
				$.ajax({
				url: '<?php echo base_url('koordinator/dashboard/get_grafik_transaksi') ?>',
				type: 'POST',
				dataType: 'JSON',
