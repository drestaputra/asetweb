...
<html class="fixed">
	...
	<body>
		...
		<script type="text/javascript">
                    ...
                    function tambah(){
                    	window.location='<?php echo base_url('user/admin/tambah'); ?>';
                    }
                    ...
                    function grid_reload() {
                        ...
                        "&status="+status+
                        "&email="+email;              
                        $("#gridview").flexOptions({url:'<?php echo base_url(); ?>user/admin/getData'+url_service}).flexReload();
                    }
                    ...
                    function delete_admin(id)
                    {
                        ...
                        {
                             var jqxhr=$.ajax({
                            url:'<?php echo base_url()?>user/admin/delete/'+id,
                            type:'get',
                            dataType:'json',
