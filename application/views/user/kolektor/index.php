       ...
       <script type="text/javascript">
			...
			$(document).ready(function() {
				...
				<?php if (isset($state) AND $state=="list"): ?>
					$('.table-responsive [name=status]').attr('name','kolektor.status');
					$('.table-responsive [name=username]').attr('name','kolektor.username');
					$('.table-responsive [name=nama]').attr('name','kolektor.nama');
					$('.table-responsive [name=email]').attr('name','kolektor.email');
					$('.table-responsive [name=no_hp]').attr('name','kolektor.no_hp');
					$('.table-responsive [name=warga_negara]').attr('name','kolektor.warga_negara');
				<?php endif ?>
